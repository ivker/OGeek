...
class OppData:
    ...
    def fitTrain(self, prefix, predict, title, tag, label):
        ...
        # *.拼接特征
        self.train_x = self._feature2vector([title, tag, max_predict, prefix_title_ed, max_predict_title_ed])
    ...
    def fitValid(self, prefix, predict, title, tag, label):
        ...
        # *.拼接特征
        self.valid_x = self._feature2vector([title, tag, max_predict, prefix_title_ed, max_predict_title_ed])
    ...
    def fitTest(self, prefix, predict, title, tag):
        ...
        # *.拼接特征
        self.test_x = self._feature2vector([title, tag, max_predict, prefix_title_ed, max_predict_title_ed])
